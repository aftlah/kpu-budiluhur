...
export default function App() {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen p-4 overflow-x-hidden bg-gradient-to-br from-blue-100 to-purple-100">
            <Toaster />
            <div className="relative w-full max-w-2xl">
                <AnimatePresence mode="wait">
                    {!isAuthenticated ? (
                        <motion.div
                            key="login"
                            className="w-full px-4 py-5 bg-white shadow-xl sm:px-8 rounded-2xl"
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                ...
                                <motion.button
                                    ...
                                    className="flex items-center justify-center w-full px-6 py-3 text-base font-semibold text-white transition-all duration-300 transform rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 sm:text-lg hover:from-blue-700 hover:to-purple-700"
                        ...
                        <motion.div
                            key="voting"
                            className="w-full px-4 py-5 bg-white shadow-xl sm:px-8 rounded-2xl"
                            initial="votingInitial"
                            animate="votingAnimate"
                            exit="votingExit"
                            variants={pageVariants}
                            transition={pageTransition}
                        >
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col items-start justify-between flex-1 space-y-4 sm:flex-row sm:items-center sm:space-y-0 sm:space-x-4">
                                            {[option.ketua, option.wakil].map((candidate) => (
                                                <motion.div
                                                    key={candidate.id}
                                                    className="flex items-center transition-transform duration-300 transform sm:flex-col sm:items-center"
                                                    whileHover={{ scale: 1.05 }}
                                                >
                                                    <img
                                                        src={candidate.photo}
                            ...
                            <motion.button
                                ...
                                className="flex items-center justify-center w-full px-6 py-3 mt-5 text-base font-semibold text-white transition-all duration-300 transform rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 sm:text-lg hover:from-blue-700 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed"
                                whileHover={{ scale: 1.05 }}
                                whileTap={{ scale: 0.95 }}
                            >
                                ...
                                {showResults && (
                                    ...
                                    >
                                        ...
                                        <motion.button
                                            ...
                                            className="flex items-center justify-center w-full px-6 py-3 mt-4 text-base font-semibold text-white transition-all duration-300 transform rounded-lg sm:mt-6 bg-gradient-to-r from-red-600 to-pink-600 sm:text-lg hover:from-red-700 hover:to-pink-700"
                                            whileHover={{ scale: 1.05 }}
                                            whileTap={{ scale: 0.95 }}
                                        >
                                            Tutup Hasil
